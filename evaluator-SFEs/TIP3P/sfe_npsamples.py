...
sfe_schema = SolvationFreeEnergy.default_simulation_schema(n_molecules=2000)
...
with DaskLocalCluster(number_of_workers=1, resources_per_worker=resources) as calculation_backend:
    ...
    a = results.estimated_properties.json("estimated_dataset_sfe_np1.json", format=True)
    print(a)
